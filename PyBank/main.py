...
CONSTANT_TITLE_OUTPUT_DATA = "Financial Analysis"

CONSTANT_TITLE_LINE_DATA = "----------------------------"
...
def writeDataToTerminalSubRoutine():
    ...
    print(CONSTANT_TITLE_OUTPUT_DATA)

    print()

    print(CONSTANT_TITLE_LINE_DATA)
...
def writeDataToFileSubRoutine():
    ...
    with open(CONSTANT_OUTPUT_FILE_NAME, "w") as txtFile:
        ...
        txtFile.write(CONSTANT_TITLE_OUTPUT_DATA)

        txtFile.write('\n\n')

        txtFile.write(CONSTANT_TITLE_LINE_DATA)
