...
CONSTANT_CANDIDATE_TIE_MESSAGE = 'The election is a tie!'
    ...
    with open(CONSTANT_INPUT_FILE_NAME) as csvFile:
        ...
        for rowDataIndex, csvRow in enumerate(csvReaderObject):
            ...
            if rowDataIndex > 1: 
                ...
                # variable.
                currentCandidateNameStringVariable \
                    = csvRow[DataColumnIndexEnumeration.CANDIDATE_INDEX.value]
            ...
            # dictionary and sets his/her vote count to one.
                ...
                currentCandidateNameStringVariable = csvRow[DataColumnIndexEnumeration.CANDIDATE_INDEX.value]
